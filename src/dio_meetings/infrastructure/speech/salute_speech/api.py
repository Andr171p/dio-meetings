...
from .exceptions import AuthorizationError, UploadError
...
class SaluteSpeechAPI(SberDevicesAPI):
    ...
    async def async_recognize(
        ...
        try:
            ...
            raise UploadError(f"Error while async recognizing: {e}") from e

    async def get_task_status(self, request_file_id: UUID) -> TaskResult:
        ...
